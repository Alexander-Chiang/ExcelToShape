        ...
        public static bool CreateXmlNodeByXPath(string xmlFileName, string xpath, string xmlNodeName, string innerText, string[] xmlAttributeName, string[] value)
        {
            ...
            try
            {
                ...
                if (xmlNode != null)
                {
                    ...
                    {
                        if (!string.IsNullOrEmpty(xmlAttributeName[i]) && !string.IsNullOrEmpty(value[i]))
                        {
                            XmlAttribute xmlAttribute = xmlDoc.CreateAttribute(xmlAttributeName[i]);
                            xmlAttribute.Value = value[i];
